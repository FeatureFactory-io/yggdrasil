"""
Ratatosk Prompt Stack for the standalone CLI runner.

Keep in sync with ``src/yggdrasil/ratatosk/prompts.py`` (same distributable strings).
"""
...
def snapshot_context_line(snapshot: dict[str, Any]) -> str:
    """Dynamic snapshot context for LLM user messages (Prompt Stack layer 4)."""
