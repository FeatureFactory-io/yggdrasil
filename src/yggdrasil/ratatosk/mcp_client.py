"""
Thin MCP HTTP client used by Ratatosk for model snapshots.

Canonical copy for in-process / Django-wired CLI. The published ``ratatosk``
package mirrors this module for remote-only installs.
"""
...
logger = logging.getLogger("yggdrasil.ratatosk.mcp_client")
...
class RatatoskMcpClient:
    """Call Yggdrasil MCP tools over HTTP with Bearer token auth."""
