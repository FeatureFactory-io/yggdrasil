"""Token-budget ModelSummary builder for in-process Ratatosk agent (SAO A5)."""
...
logger = logging.getLogger("yggdrasil.ratatosk.model_summary")
...
def build_model_summary(
    ...
    *,
    ...
    :param elements: Element dicts from snapshot/MCP.
    :param relationships: Relationship dicts (optional).
    :param budget_tokens: Max token budget.
